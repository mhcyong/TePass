...
2、胖蒜网：https://pangsuan.com/service.html   
因站长隐私要求，更多站点不再列出，可购买插件后进群交流。  
    

## 五、更新日志 ##
2022-12-12：发布TePass-1.4.1版本，修复未开启邮箱验证注册还提醒请不要随意更换邮箱的BUG。  
2022-12-12：发布TePass-1.4.0版本，修改默认支付方式为支付宝，增加注册邮箱验证，修复几处BUG。  
2022-05-04：发布TePass-1.3.9版本，修复输出摘要的Bug，美化后台付费设置区。  
2022-04-28：发布TePass-1.3.8版本，中间升级几个小版本，虎皮椒支付增加了H5方式收款。 2022-03-28：发布TePass-1.3.5版本，因payjs关闭支付宝商户，故调整支付方式。  
2022-03-19：发布TePass-1.3.3版本，冒泡更新一点东西。  
2021-10-12：修复邀请码注册和忘记密码重置发送邮件的一些问题。  
2021-09-16：修复登陆页面一处bug。  
2021-09-09：发布TePass-1.3.1版本，主要目的是兼容PHP8，另外修复了一下小问题。  
2021-08-09：发布TePass-1.2.2版本，修复部分主题下输出内容空白的问题。  
2021-08-08：发布TePass -1.2.1版本，调整了支付方式的设置方式，修复Rss中暴露隐藏内容等问题。  
2021-04-28：发布TePass-1.1.4版本，增加payjs支付宝商户，增加对PHP7.4的支持。  
...
2020-09-03：发布TePass-0.8.4版本，修复一处严重bug，完善一些细节。 2020-08-14：发布TePass-0.8.3版本，付款弹窗界面增加倒计时功能，优化性能，修复bug。  
